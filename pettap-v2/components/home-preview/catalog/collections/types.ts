...
export function createCollectionModels(collection: CollectionId, folder: string, entries: readonly string[], supportsName = false, options?: { season?: SeasonalId; idPrefix?: string }): CollectionModel[] {
