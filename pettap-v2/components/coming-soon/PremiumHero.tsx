...
export default function PremiumHero() {
  ...
  return (
    <section aria-labelledby="hero-title" className="relative isolate overflow-hidden">
      ...
      <div className="mx-auto grid max-w-7xl items-center gap-10 px-6 pb-16 pt-10 sm:gap-14 sm:pb-24 sm:pt-16 lg:grid-cols-[minmax(0,0.94fr)_minmax(0,1.06fr)] lg:gap-8 lg:px-8 lg:pb-28 lg:pt-20">
        <motion.div
        ...
        >
          ...
          <motion.div variants={reveal} transition={transition} className="mx-auto mt-7 max-w-xl text-pretty text-[1.05rem] leading-7 text-neutral-600 lg:mx-0 lg:text-lg lg:leading-8">
            <p>The smart NFC pet tag that helps lost pets find their families faster.</p>
            <p className="mt-3 font-medium text-neutral-800">No batteries. No subscription. Just one tap.</p>
          </motion.div>
        ...
        <motion.div
          ...
          className="relative mx-auto w-full max-w-[37rem] lg:max-w-none"
        >
          <motion.div
