    ...
    <footer className="relative z-10 border-t border-black/[0.06] px-6 py-9">
      <div className="mx-auto flex max-w-6xl flex-col gap-5 text-sm text-neutral-500 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex flex-wrap gap-x-5 gap-y-3">
          ...
          <Link href="/shipping" className="rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neutral-950 focus-visible:ring-offset-2">Shipping</Link>
          <Link href="/returns" className="rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neutral-950 focus-visible:ring-offset-2">Returns</Link>
